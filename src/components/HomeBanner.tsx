          ...
          >
            ...
            <div className="container mx-auto px-4">
              <div className="absolute bottom-10 py-4 w-3/4 lg:max-w-2/3 text-neutral-100">
                ...
                <button className="bg-orange-600 hover:bg-gradient-to-r from-red-600 font-bold to-orange-700 hover:scale-105 text-neutral-100 px-4 py-2 my-4 rounded-sm shadow-md transition-all cursor-pointer">
                  Play Now
                </button>
              </div>
            </div>
